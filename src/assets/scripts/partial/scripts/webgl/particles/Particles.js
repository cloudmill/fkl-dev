...
export default class Particles {
	...
	show(time = 1.0) {
		...
		TweenLite.to(this.object3D.material.uniforms.uRandom, time, { value: 6.0 });
		TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time * 1.5, { value: 40.0 }, { value: 10.0 });
